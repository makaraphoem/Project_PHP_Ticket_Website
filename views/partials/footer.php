                ...
                <div class="md:flex md:justify-between">
                    ...
                    <div class="mb-6 md:mb-0">
                        <a href="/" class="flex items-center">
                            ...
                            <span class="self-center text-2xl font-sans whitespace-nowrap text-white">Join plush</span>
                        </a>
                        <div class="">
                            <ul class="text-gray-600 dark:text-gray-400">
                                <li class="mb-4 md:mt-10">
                                    <a href="#" class="hover:underline text-white font-sans hover:text-red-800 text-lg ml-8">Follow us on</a>
                                </li>
                            </ul>  
                        </div>
                        <div class="sm:flex sm:items-center sm:justify-between">
                            <div class="flex  space-x-3 sm:mt-0 mt-8 ">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 class="mb-6 text-lg font-semibold  uppercase text-red-500 font-sans"> Friends & Partners</h2>
                            <ul class="text-gray-600 dark:text-gray-400">
                                <li class="mb-4">
                                    <a href="#" class="hover:underline text-white hover:text-red-800 font-sans">American Express</a>
                                </li>
                                <li class="mb-4">
